...
function refresh() {
  ...
  fetch("https://cors-everywhere.herokuapp.com/clouddata.scratch.mit.edu/logs?projectid=" + document.getElementById("server").value + "&limit=40&offset=0")
    ...
    .then(function (j) {
      ...
      for (var x = 0; x < j.length; x++) {
        ...
        dataHTML += "<p><a href='https://scratch.mit.edu/users/" + user + "'>" + user + "</a>: <span style='font-size: 24px;'>" + text + "</span> <i style='color:#ddd'>" + datestring + "</i></p>";
